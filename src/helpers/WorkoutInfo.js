...
const exercise = [
    ...
    },
    {
        ...
        duration: "20reps" ,
        steps: "Lay on your back. Place your feet hip-width apart on the floor. Place your arms over your chest while bending your knees. Inhale while contracting your abs. Exhale and elevate your upper body while maintaining a relaxed head and neck. Return to the starting position by inhaling.",
    },
    {
        id: 4,
    ...
    },
    {
        ...
        workoutName: "Run",
        duration: "20mins" ,
        steps: "Go for a light jog outside",
    },
    {
        id: 8,
...
const probability = [ 2,2,2,2,2,2,4,1,1,1,1];
let randWorkouts = [];

exercise.forEach((item, index) => {
    var clone = Array(probability[index]).fill(item);
    randWorkouts.push(...clone);
 });

export const ItemProvider = ({children}) => {
    return (
        <WorkoutInfo.Provider key={Math.floor(Math.random()*99999)} value={randWorkouts}>
            {children}
